...
public interface AgentMonitorService {
     ...
     * @return 指标 ID
     */
    Long createMetric(AgentMonitorSaveReqVO saveReqVO);
     ...
     * @return 指标详情
     */
    AgentMonitorRespVO getMetric(Long id);
     ...
     * @return 指标分页结果
     */
    PageResult<AgentMonitorRespVO> getMetricPage(AgentMonitorPageReqVO pageReqVO);
     ...
     * @return 指标列表
     */
    List<AgentMonitorRespVO> getMetricListByAgentUuidAndType(String agentUuid, String metricType);
     ...
     * @return 指标列表
     */
    List<AgentMonitorRespVO> getMetricListByAgentUuidAndTimeRange(String agentUuid, LocalDateTime startTime, LocalDateTime endTime);
     ...
     * @return 监控统计信息
     */
    AgentMonitorStatisticsRespVO getAgentStatistics(String agentUuid, LocalDateTime startTime, LocalDateTime endTime);
