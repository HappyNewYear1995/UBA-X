 ...
 */
@Mapper
public interface MonitorMetricMapper extends BaseMapperX<AgentMonitorMetricDO> {

    default PageResult<AgentMonitorMetricDO> selectPage(MonitorMetricPageReqVO reqVO) {
