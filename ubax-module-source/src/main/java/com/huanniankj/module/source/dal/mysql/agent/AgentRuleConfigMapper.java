 ...
 */
@Mapper
public interface AgentRuleConfigMapper extends BaseMapperX<AgentRuleConfigDO> {

    default PageResult<AgentRuleConfigDO> selectPage(AgentRuleConfigPageReqVO reqVO) {
