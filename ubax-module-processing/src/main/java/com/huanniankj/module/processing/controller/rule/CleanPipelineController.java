package com.huanniankj.module.processing.controller.rule;
...
import com.huanniankj.module.processing.controller.rule.vo.CleanPipelineRespVO;
import com.huanniankj.module.processing.controller.rule.vo.CleanPipelineSaveReqVO;
import com.huanniankj.module.processing.dal.dataobject.rule.CleanPipelineDO;
import com.huanniankj.module.processing.service.rule.CleanPipelineService;
...
@Tag(name = "清洗管道")
@RestController
@RequestMapping("/processing/clean-pipeline")
@Validated
public class CleanPipelineController {
    ...
    @PreAuthorize("@ss.hasPermission('processing:clean-pipeline:create')")
    ...
    @PreAuthorize("@ss.hasPermission('processing:clean-pipeline:update')")
    ...
    @PreAuthorize("@ss.hasPermission('processing:clean-pipeline:delete')")
    ...
    @Parameter(name = "id", description = "管道 ID", required = true, example = "1024")
    @PreAuthorize("@ss.hasPermission('processing:clean-pipeline:query')")
