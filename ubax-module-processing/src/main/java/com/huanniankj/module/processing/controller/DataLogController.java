...
import com.huanniankj.module.processing.controller.vo.DataLogRespVO;
import com.huanniankj.module.processing.controller.vo.DataLogSaveReqVO;
import com.huanniankj.module.processing.dal.dataobject.DataLogDO;
import com.huanniankj.module.processing.service.DataLogService;
...
@Tag(name = "数据日志")
@RestController
@RequestMapping("/collect/data-log")
@Validated
