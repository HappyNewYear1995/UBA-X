package com.huanniankj.module.processing.service.rule;
...
import com.huanniankj.module.processing.dal.mysql.rule.CleanPipelineMapper;
...
import static com.huanniankj.module.processing.enums.ErrorCodeConstants.CLEAN_PIPELINE_NAME_DUPLICATE;
import static com.huanniankj.module.processing.enums.ErrorCodeConstants.CLEAN_PIPELINE_NOT_EXISTS;
...
public class CleanPipelineServiceImpl implements CleanPipelineService {
    ...
    public List<CleanPipelineDO> getCleanPipelineList() {
        return cleanPipelineMapper.selectList(CleanPipelineDO::getStatus, CommonStatusEnum.ENABLE);
    }
