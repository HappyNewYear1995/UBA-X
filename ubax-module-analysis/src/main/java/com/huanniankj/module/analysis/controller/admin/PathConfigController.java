package com.huanniankj.module.analysis.controller.admin;
...
import com.huanniankj.module.analysis.service.PathConfigService;
 ...
 * @author zhaoff
 */
@Tag(name = "管理后台 - 路径分析配置", description = "路径分析配置的增删改查及结果查询")
@RestController
