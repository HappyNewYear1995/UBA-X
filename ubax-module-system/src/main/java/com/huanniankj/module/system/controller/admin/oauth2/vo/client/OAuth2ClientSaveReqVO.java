package com.huanniankj.module.system.controller.admin.oauth2.vo.client;
...
public class OAuth2ClientSaveReqVO {
    ...
    @Schema(description = "客户端密钥", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
    ...
    @Schema(description = "应用图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
    @NotNull(message = "应用图标不能为空")
    @URL(message = "应用图标的地址不正确")
    private String logo;

    @Schema(description = "应用描述", example = "ubax")
    ...
    @Schema(description = "可重定向的 URI 地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
    ...
    @Schema(description = "附加信息", example = "{ubax: true}")
