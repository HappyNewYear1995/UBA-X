package com.huanniankj.module.system.controller.notify.vo.template;
 ...
 * @author zhaoff
 */
@Schema(description = "站内信模版 Response VO")
@Data
public class NotifyTemplateRespVO {
    ...
    @Schema(description = "发送人名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
    private String nickname;

    @Schema(description = "模版内容", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
