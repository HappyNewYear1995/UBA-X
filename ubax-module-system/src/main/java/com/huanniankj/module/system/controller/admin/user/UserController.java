package com.huanniankj.module.system.controller.admin.user;
...
import com.huanniankj.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.huanniankj.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.huanniankj.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.huanniankj.module.system.controller.admin.user.vo.user.UserRespVO;
import com.huanniankj.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.huanniankj.module.system.controller.admin.user.vo.user.UserSimpleRespVO;
import com.huanniankj.module.system.controller.admin.user.vo.user.UserUpdatePasswordReqVO;
import com.huanniankj.module.system.controller.admin.user.vo.user.UserUpdateStatusReqVO;
...
import com.huanniankj.module.system.enums.common.SexEnum;
...
public class UserController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("xxx").deptId(1L).email("xxx@xxx.com").mobile("12312341234")
                        .nickname("xxx").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
                UserImportExcelVO.builder().username("xxx").deptId(2L).email("xxx@xxx.com").mobile("12312341234")
                        .nickname("xxx").status(CommonStatusEnum.DISABLE.getStatus()).sex(SexEnum.FEMALE.getSex()).build()
        );
        // 输出
