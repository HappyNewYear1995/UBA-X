package com.huanniankj.module.system.controller.admin.oauth2;
...
import com.huanniankj.framework.common.util.json.JsonUtils;
import com.huanniankj.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.huanniankj.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.huanniankj.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.huanniankj.module.system.convert.oauth2.OAuth2OpenConvert;
import com.huanniankj.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.huanniankj.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import com.huanniankj.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import com.huanniankj.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.huanniankj.module.system.service.oauth2.OAuth2ApproveService;
import com.huanniankj.module.system.service.oauth2.OAuth2ClientService;
import com.huanniankj.module.system.service.oauth2.OAuth2GrantService;
import com.huanniankj.module.system.service.oauth2.OAuth2TokenService;
import com.huanniankj.module.system.util.oauth2.OAuth2Utils;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "ubax"),
            @Parameter(name = "state", description = "状态", example = "1"),
            @Parameter(name = "username", example = "ubax"),
    ...
    @Parameter(name = "clientId", required = true, description = "客户端编号", example = "ubax")
    ...
    @Parameters({
            ...
            @Parameter(name = "client_id", required = true, description = "客户端编号", example = "ubax"),
            @Parameter(name = "scope", description = "授权范围", example = "userinfo.read"), // 使用 Map<String, Boolean> 格式，Spring MVC 暂时不支持这么接收参数
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "ubax"),
