package com.huanniankj.module.system.controller.admin.mail.vo.log;
...
public class MailLogRespVO {
    ...
    @Schema(description = "发送邮箱地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
    ...
    @Schema(description = "模版发送人名称", example = "ubax")
