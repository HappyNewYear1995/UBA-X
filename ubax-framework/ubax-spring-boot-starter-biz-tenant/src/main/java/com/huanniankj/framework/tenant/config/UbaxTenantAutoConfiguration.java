...
import com.huanniankj.framework.redis.config.UbaxCacheProperties;
...
import com.huanniankj.framework.tenant.core.aop.TenantIgnoreAspect;
import com.huanniankj.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.huanniankj.framework.tenant.core.job.TenantJobAspect;
import com.huanniankj.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.huanniankj.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.huanniankj.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.huanniankj.framework.tenant.core.redis.TenantRedisCacheManager;
import com.huanniankj.framework.tenant.core.security.TenantSecurityWebFilter;
import com.huanniankj.framework.tenant.core.service.TenantFrameworkService;
import com.huanniankj.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.huanniankj.framework.tenant.core.web.TenantContextWebFilter;
...
public class UbaxTenantAutoConfiguration {
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     UbaxCacheProperties ubaxCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(ubaxCacheProperties.getRedisScanBatchSize()));
