package com.huanniankj.framework.mybatis.config;
...
import com.huanniankj.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${ubax.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class UbaxMybatisAutoConfiguration {
