package com.huanniankj.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${ubax.websocket.sender-rocketmq.topic}",
        consumerGroup = "${ubax.websocket.sender-rocketmq.consumer-group}",
