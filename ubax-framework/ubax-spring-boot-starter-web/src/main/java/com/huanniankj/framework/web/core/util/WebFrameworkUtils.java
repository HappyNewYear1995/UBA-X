package com.huanniankj.framework.web.core.util;

import cn.hutool.core.util.NumberUtil;
import com.huanniankj.framework.common.enums.TerminalEnum;
...
public class WebFrameworkUtils {
    ...
    public static Integer getLoginUserType(HttpServletRequest request) {
        ...
        // 2. 其次，基于 URL 前缀的约定
        if (request.getServletPath().startsWith(properties.getApi().getPrefix())) {
