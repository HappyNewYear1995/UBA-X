package com.huanniankj.framework.web.config;
...
import com.huanniankj.framework.web.core.filter.CacheRequestBodyFilter;
import com.huanniankj.framework.web.core.filter.DemoFilter;
import com.huanniankj.framework.web.core.handler.GlobalExceptionHandler;
import com.huanniankj.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class UbaxWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "ubax.demo", havingValue = "true")
