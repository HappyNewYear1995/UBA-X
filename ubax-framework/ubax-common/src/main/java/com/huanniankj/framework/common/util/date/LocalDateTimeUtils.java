package com.huanniankj.framework.common.util.date;
...
import com.huanniankj.framework.common.enums.DateIntervalEnum;
...
public class LocalDateTimeUtils {
    ...
    public static String formatDateRange(LocalDateTime startTime, LocalDateTime endTime, Integer interval) {
        ...
        return switch (intervalEnum) {
            case HOUR -> LocalDateTimeUtil.format(startTime, DatePattern.NORM_DATETIME_MINUTE_PATTERN);
