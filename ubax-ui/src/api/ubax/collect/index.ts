...
export const createEventConfig = (data: EventConfigSaveReqVO) => {
  return request.post({ url: '/collect/event-config/create', data })
}

/** 更新事件配置 */
export const updateEventConfig = (data: EventConfigSaveReqVO) => {
  return request.put({ url: '/collect/event-config/update', data })
}

/** 删除事件配置 */
export const deleteEventConfig = (id: number) => {
  return request.delete({ url: '/collect/event-config/delete', params: { id } })
}

/** 获取事件配置详情 */
export const getEventConfig = (id: number) => {
  return request.get({ url: '/collect/event-config/get', params: { id } })
}

/** 获取事件配置分页 */
export const getEventConfigPage = (params: EventConfigPageReqVO) => {
  return request.get({ url: '/collect/event-config/page', params })
}

/** 获取事件配置精简列表 */
export const getSimpleEventConfigList = () => {
  return request.get({ url: '/collect/event-config/list-all-simple' })
}
...
export const createEvent = (data: EventSaveReqVO) => {
  return request.post({ url: '/collect/event/create', data })
}

/** 删除事件 */
export const deleteEvent = (id: number) => {
  return request.delete({ url: '/collect/event/delete', params: { id } })
}

/** 获取事件详情 */
export const getEvent = (id: number) => {
  return request.get({ url: '/collect/event/get', params: { id } })
}

/** 获取事件分页 */
export const getEventPage = (params: EventPageReqVO) => {
  return request.get({ url: '/collect/event/page', params })
}
...
export const createCleanPipeline = (data: CleanPipelineSaveReqVO) => {
  return request.post({ url: '/collect/clean-pipeline/create', data })
}

/** 更新清洗管道 */
export const updateCleanPipeline = (data: CleanPipelineSaveReqVO) => {
  return request.put({ url: '/collect/clean-pipeline/update', data })
}

/** 删除清洗管道 */
export const deleteCleanPipeline = (id: number) => {
  return request.delete({ url: '/collect/clean-pipeline/delete', params: { id } })
}

/** 获取清洗管道详情 */
export const getCleanPipeline = (id: number) => {
  return request.get({ url: '/collect/clean-pipeline/get', params: { id } })
}

/** 获取清洗管道分页 */
export const getCleanPipelinePage = (params: CleanPipelinePageReqVO) => {
  return request.get({ url: '/collect/clean-pipeline/page', params })
}

/** 获取清洗管道精简列表 */
export const getSimpleCleanPipelineList = () => {
  return request.get({ url: '/collect/clean-pipeline/list-all-simple' })
}
...
export const createErrorLog = (data: ErrorLogSaveReqVO) => {
  return request.post({ url: '/collect/error-log/create', data })
}

/** 更新异常日志 */
export const updateErrorLog = (data: ErrorLogSaveReqVO) => {
  return request.put({ url: '/collect/error-log/update', data })
}

/** 删除异常日志 */
export const deleteErrorLog = (id: number) => {
  return request.delete({ url: '/collect/error-log/delete', params: { id } })
}

/** 获取异常日志详情 */
export const getErrorLog = (id: number) => {
  return request.get({ url: '/collect/error-log/get', params: { id } })
}

/** 获取异常日志分页 */
export const getErrorLogPage = (params: ErrorLogPageReqVO) => {
  return request.get({ url: '/collect/error-log/page', params })
}
...
export const createDataLog = (data: DataLogSaveReqVO) => {
  return request.post({ url: '/collect/data-log/create', data })
}

/** 删除数据日志 */
export const deleteDataLog = (id: number) => {
  return request.delete({ url: '/collect/data-log/delete', params: { id } })
}

/** 获取数据日志详情 */
export const getDataLog = (id: number) => {
  return request.get({ url: '/collect/data-log/get', params: { id } })
}

/** 获取数据日志分页 */
export const getDataLogPage = (params: DataLogPageReqVO) => {
  return request.get({ url: '/collect/data-log/page', params })
}
