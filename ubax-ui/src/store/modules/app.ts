  ...
  state: (): AppState => {
    return {
      ...
      theme: wsCache.get(CACHE_KEY.THEME) || {
        // 主题色
        elColorPrimary: '#79a8f9',
        // 左侧菜单边框颜色
        leftMenuBorderColor: 'inherit',
        // 左侧菜单背景颜色
        leftMenuBgColor: '#ffffff',
        // 左侧菜单浅色背景颜色
        leftMenuBgLightColor: '#f8f9fc',
        // 左侧菜单选中背景颜色
        leftMenuBgActiveColor: 'var(--el-color-primary)',
        // 左侧菜单收起选中背景颜色
        leftMenuCollapseBgActiveColor: 'var(--el-color-primary)',
        // 左侧菜单字体颜色
        leftMenuTextColor: '#5a6178',
        // 左侧菜单选中字体颜色
        leftMenuTextActiveColor: '#fff',
        // logo字体颜色
        logoTitleTextColor: '#1a1f4d',
        // logo边框颜色
        logoBorderColor: 'inherit',
        // 头部背景颜色
        topHeaderBgColor: '#ffffff',
        // 头部字体颜色
        topHeaderTextColor: '#1a1f4d',
        // 头部悬停颜色
        topHeaderHoverColor: 'rgba(102, 126, 234, 0.08)',
        // 头部边框颜色
        topToolBorderColor: 'rgba(0, 0, 0, 0.06)'
      }
    }
  },
  getters: {
