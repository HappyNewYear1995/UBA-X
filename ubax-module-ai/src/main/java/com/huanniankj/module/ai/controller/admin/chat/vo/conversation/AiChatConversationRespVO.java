package com.huanniankj.module.ai.controller.admin.chat.vo.conversation;
...
public class AiChatConversationRespVO implements VO {
    ...
    @Schema(description = "对话标题", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
    ...
    @Schema(description = "模型名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
    private String modelName;

    @Schema(description = "角色设定", example = "ubax")
    private String systemMessage;

    @Schema(description = "温度参数", requiredMode = Schema.RequiredMode.REQUIRED, example = "0.8")
    private Double temperature;

    @Schema(description = "单条回复的最大 Token 数量", requiredMode = Schema.RequiredMode.REQUIRED, example = "1024")
    ...
    @Schema(description = "角色头像", example = "ubax")
