package com.huanniankj.module.ai.controller.admin.knowledge.vo.knowledge;
...
public class AiKnowledgeRespVO {
    ...
    @Schema(description = "知识库名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
    private String name;

    @Schema(description = "知识库描述", example = "ubax")
    private String description;

    @Schema(description = "向量模型编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "14")
    private Long embeddingModelId;

    @Schema(description = "向量模型标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
