package com.huanniankj.module.ai.framework.ai.core.model;
...
import com.huanniankj.framework.common.util.spring.SpringUtils;
import com.huanniankj.module.ai.enums.model.AiPlatformEnum;
import com.huanniankj.module.ai.framework.ai.config.AiAutoConfiguration;
import com.huanniankj.module.ai.framework.ai.config.UbaxAiProperties;
...
import com.huanniankj.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.huanniankj.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            UbaxAiProperties.Midjourney properties = SpringUtil.getBean(UbaxAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(UbaxAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        UbaxAiProperties.DouBao properties = new UbaxAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(UbaxAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        UbaxAiProperties.HunYuan properties = new UbaxAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(UbaxAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        UbaxAiProperties.SiliconFlow properties = new UbaxAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(UbaxAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        UbaxAiProperties.XingHuo properties = new UbaxAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(UbaxAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        UbaxAiProperties.BaiChuan properties = new UbaxAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(UbaxAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        UbaxAiProperties.Gemini properties = SpringUtil.getBean(UbaxAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey, String url) {
        UbaxAiProperties.Grok properties = new UbaxAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
