...
public class AiWriteRespVO {
    ...
    @Schema(description = "平台", requiredMode = Schema.RequiredMode.REQUIRED, example = "xxx")
    private String platform;

    @Schema(description = "模型", requiredMode = Schema.RequiredMode.REQUIRED, example = "xxx")
    private String model;

    @Schema(description = "生成内容提示", requiredMode = Schema.RequiredMode.REQUIRED, example = "xxx")
    private String prompt;

    @Schema(description = "生成的内容", example = "xxx")
