package com.huanniankj.module.ai.controller.admin.image.vo.midjourney;
...
public class AiMidjourneyImagineReqVO {
    ...
    @Schema(description = "提示词", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
    ...
    @Schema(description = "参考图", example = "ubax")
