package com.huanniankj.module.ai.service.chat;
...
import com.huanniankj.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.huanniankj.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.huanniankj.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.huanniankj.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.huanniankj.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.huanniankj.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.huanniankj.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.huanniankj.module.ai.dal.dataobject.model.AiChatRoleDO;
...
import com.huanniankj.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.huanniankj.module.ai.enums.ErrorCodeConstants;
...
import com.huanniankj.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.huanniankj.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.huanniankj.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.huanniankj.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.huanniankj.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.huanniankj.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.huanniankj.module.ai.service.model.AiChatRoleService;
import com.huanniankj.module.ai.service.model.AiModelService;
import com.huanniankj.module.ai.service.model.AiToolService;
import com.huanniankj.module.ai.util.AiUtils;
import com.huanniankj.module.ai.util.FileTypeUtils;
...
import static com.huanniankj.framework.common.pojo.CommonResult.error;
...
import static com.huanniankj.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.huanniankj.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 ubax.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 ubax.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
