package com.huanniankj.module.ai.controller.admin.music;
...
import com.huanniankj.module.ai.controller.admin.music.vo.AiMusicRespVO;
...
import com.huanniankj.module.ai.service.music.AiMusicService;
...
public class AiMusicController {
    ...
    @Parameter(name = "title", required = true, description = "音乐名称", example = "ubax")
