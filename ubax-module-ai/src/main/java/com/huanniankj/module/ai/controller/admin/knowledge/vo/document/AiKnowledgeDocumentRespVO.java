...
public class AiKnowledgeDocumentRespVO {
    ...
    @Schema(description = "文档 URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
    private String url;

    @Schema(description = "文档内容", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
