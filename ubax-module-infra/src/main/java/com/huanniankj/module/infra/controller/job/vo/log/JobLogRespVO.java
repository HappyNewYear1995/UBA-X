package com.huanniankj.module.infra.controller.job.vo.log;
 ...
 * @author zhaoff
 */
@Schema(description = "定时任务日志 Response VO")
@Data
...
public class JobLogRespVO {
    ...
    @Schema(description = "处理器的参数", example = "ubax")
    ...
    @Schema(description = "执行时长", example = "1")
    @ExcelProperty("执行时长")
