package com.huanniankj.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @Schema(description = "链路追踪编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
    ...
    @Schema(description = "操作模块", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
    @ExcelProperty("操作模块")
    private String operateModule;

    @Schema(description = "操作名", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax")
    @ExcelProperty("操作名")
    ...
    @Schema(description = "结果提示", example = "ubax")
    @ExcelProperty("结果提示")
