package com.huanniankj.module.infra.controller.config.vo;
...
/**
 * 参数配置创建/修改 Request VO
 *
 * @author zhaoff
 */
@Schema(description = "参数配置创建/修改 Request VO")
@Data
public class ConfigSaveReqVO {
    ...
    @Schema(description = "参数键名", requiredMode = Schema.RequiredMode.REQUIRED, example = "ubax.db.username")
