...
import com.huanniankj.module.infra.convert.file.FileConfigConvert;
import com.huanniankj.module.infra.dal.dataobject.file.FileConfigDO;
import com.huanniankj.module.infra.dal.mysql.file.FileConfigMapper;
...
import static com.huanniankj.framework.common.util.cache.CacheUtils.buildAsyncReloadingCache;
import static com.huanniankj.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
...
public class FileConfigServiceImpl implements FileConfigService {
    ...
    public String testFileConfig(Long id) throws Exception {
        ...
        validateFileConfigExists(id);
        // 上传文件
        byte[] content = ResourceUtil.readBytes("file/ubax.jpg");
